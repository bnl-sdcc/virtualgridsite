    ...
    \colorbox{htcondorbox}{
        ...
        \small
            \bf{JOB\_ROUTER\_HOOK\_KEYWORD = NOVA \newline \newline
                %NOVA\_HOOK\_TRANSLATE\_JOB = \newline \hspace*{1cm}/usr/share/virtualgridsite/nova\_hook\_translate\_job \newline
                %NOVA\_HOOK\_UPDATE\_JOB\_INFO = \newline \hspace*{1cm}/usr/libexec/nova\_hook\_update\_job\_info \newline
                %NOVA\_HOOK\_JOB\_EXIT = \newline \hspace*{1cm}/usr/libexec/nova\_hook\_job\_exit \newline
                %NOVA\_HOOK\_JOB\_CLEANUP = \newline \hspace*{1cm}/usr/libexec/nova\_hook\_cleanup\_job
